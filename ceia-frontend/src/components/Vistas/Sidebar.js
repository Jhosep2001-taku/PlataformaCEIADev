...
const menuItems = [
    ...
    { text: 'Historial de Mantenimientos', icon: <AttachMoneyIcon />, path: '/historiales' },
    { text: 'Historial Equipos', icon: <BuildIcon />, path: '/historiales-equipos' },
    { text: 'Calendario de Trabajo', icon: <CalendarMonthIcon />, path: '/calendarioTrabajo' }
];
